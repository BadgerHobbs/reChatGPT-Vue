  ...
  <header class="Header">
    <div class="Header-item Header-item--full">
      <a href="/" class="Header-link f3 d-flex flex-items-center">
        <img :src="favicon" class="mr-2" style="height: 1.75rem;">
        <span>reChatGPT</span>
      </a>
    </div>
    ...
    <div class="Header-item mr-0">
      ...
      <details class="details-reset details-overlay details-overlay-dark color-fg-default">

        <summary class="btn-octicon">
          <svg class="octicon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
